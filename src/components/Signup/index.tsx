...
// name password email
function Signup(props: { trigger: any; children: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined; setTrigger: (arg0: boolean) => void }) {
